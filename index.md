...
With our first generated image dataset which was 512x512 images, we could not increase the batch size beyond 16. In order to pass this threshold, we reduced the size of the images in the second data set and experimented with different image sizes and various batch sizes. Below are the results from our batch size testing on reduced image sizes:
...
Batch size = 14 epoch train_loss valid_loss error_rate time
...
Batch size = 12 epoch train_loss valid_loss error_rate time
...
Batch size = 24, items_tfms=Resize(400) epoch train_loss valid_loss error_rate time
...
Batch size = 32, items_tfms=Resize(400) epoch train_loss valid_loss error_rate time
...
Resnet18 0 1.266850 2.942806 0.509677 0.000000 0.000000 0.000000 00:11
...
Resnet34 0 1.186446 2.405405 0.509677 0.000000 0.000000 0.000000 00:32
epoch train_loss valid_loss error_rate recall_score precision_score f1_score time
...
Resnet50 epoch train_loss valid_loss error_rate recall_score precision_score f1_score time
...
Batch size = 16 epoch train_loss valid_loss error_rate recall_score precision_score f1_score time
...
training loss consistently decreases, validation loss hovers around 0.7 Batch size = 8 0 1.294832 0.846603 0.357447 0.000000 0.000000 0.000000 00:14
epoch train_loss valid_loss error_rate recall_score precision_score f1_score time
...
Batch size = 4 epoch train_loss valid_loss error_rate recall_score precision_score f1_score time
...
Batch size = 24 epoch train_loss valid_loss error_rate recall_score precision_score f1_score time
...
Batch size = 32 epoch train_loss valid_loss error_rate recall_score precision_score f1_score time
...
Batch size = 40 epoch train_loss valid_loss error_rate recall_score precision_score f1_score time
...
Batch size = 64 epoch train_loss valid_loss error_rate recall_score precision_score f1_score time
...
Resizing Testing: new approach resize down 400x400, batch size 128,

Resnet34, Batch size 128, epoch 15, resize factor 400 epoch train_loss valid_loss error_rate recall_score precision_score f1_score time
...
double test Resnet34, Batch size 128, epoch 15, resize factor 400 epoch train_loss valid_loss error_rate recall_score precision_score f1_score time
0 1.206917 0.728770 0.357447 0.178571 0.500000 0.263158 00:15
epoch train_loss valid_loss error_rate recall_score precision_score f1_score time
0 1.129427 0.736311 0.374468 0.416667 0.472973 0.443038 00:18
1 1.115820 1.192699 0.608511 0.904762 0.360190 0.515254 00:18
...
Resnet34, Batch size 128, epoch 15, resize factor 500 epoch train_loss valid_loss error_rate recall_score precision_score f1_score time
...
Resnet34, Batch size 128, epoch 15, resize factor 300 epoch train_loss valid_loss error_rate recall_score precision_score f1_score time
0 1.206917 0.728770 0.357447 0.178571 0.500000 0.263158 00:15
epoch train_loss valid_loss error_rate recall_score precision_score f1_score time
0 1.129427 0.736311 0.374468 0.416667 0.472973 0.443038 00:18
1 1.115820 1.192699 0.608511 0.904762 0.360190 0.515254 00:18
...
Resnet34, Batch size 32, epoch 15 epoch train_loss valid_loss error_rate recall_score precision_score f1_score time
0 0.592978 0.556228 0.248454 0.000922 0.500000 0.001840 03:32
epoch train_loss valid_loss error_rate recall_score precision_score f1_score time
/home/CAMPUS/slab2019/anaconda3/lib/python3.8/site-packages/sklearn/metrics/_classification.py:1221: UndefinedMetricWarning: Precision is ill-defined and being set to 0.0 due to no predicted samples. Use zero_division parameter to control this behavior. _warn_prf(average, modifier, msg_start, len(result)) 0 0.488386 0.615993 0.248454 0.000000 0.000000 0.000000 04:50
...
Resnet34, Batch size 64, epoch 15 epoch train_loss valid_loss error_rate recall_score precision_score f1_score time
